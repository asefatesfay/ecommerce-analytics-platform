...
def main():
    ...
    # Header
    st.markdown(
        '<div class="main-header">🏪 E-commerce Analytics Dashboard</div>',
        unsafe_allow_html=True,
    )
    ...
    # Sidebar filters
    st.sidebar.markdown(
        '<div class="sidebar-info"><h3>📊 Dashboard Filters</h3></div>',
        unsafe_allow_html=True,
    )
    ...
    with col3:
        st.metric(label="👥 Active Customers", value=f"{kpis['total_customers']:,}")
